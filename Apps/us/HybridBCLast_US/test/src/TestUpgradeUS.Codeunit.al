codeunit 139914 "Test Upgrade US"
{
    Subtype = Test;
    ...
    begin
        // [SCENARIO] US data migration (14x -> 15x) runs the correct upgrade code for the IRS 1099 stuff.
    ...
    var
        ...
        W1CompanyHandler: Codeunit "W1 Company Handler";
    begin
        // [SCENARIO] US data migration (14x -> 15x) runs upgrade code for the CFDI fields on sales documents
    ...
    var
        ...
        W1CompanyHandler: Codeunit "W1 Company Handler";
    begin
        // [SCENARIO] US data migration (14x -> 15x) runs upgrade code for the CFDI fields on service documents
        // [GIVEN] Customer records exist with a CFDI purpose
        Customer.FindFirst();
        Customer."CFDI Purpose" := 'CHG';
        Customer."CFDI Relation" := 'DEU';
    ...
    begin
        // [SCENARIO] US table mapping for 15.0 to 16.0 upgrade
